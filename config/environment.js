...
const envvars = {
  ...
  TEST_HTTP_PROTOCOL:      process.env.TEST_HTTP_PROTOCOL || 'http',
  TEST_HTTP_HOST:          process.env.TEST_HTTP_HOST || 'localhost',
  TEST_HTTP_PORT:          process.env.DJANGO_HTTP_PORT || process.env.TEST_HTTP_PORT,
