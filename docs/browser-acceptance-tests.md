...
suites under the
[`test/browser_tests/cucumber-new/features`](https://github.com/cfpb/cfgov-refresh/tree/master/test/browser_tests/cucumber-new/features)
directory.

Our legacy browser tests are all in the
[`test/browser_tests/cucumber/features`](https://github.com/cfpb/cfgov-refresh/tree/master/test/browser_tests/cucumber/features)
...
[`test/browser_tests/cucumber-new/features/suites`](https://github.com/cfpb/cfgov-refresh/tree/master/test/browser_tests/cucumber-new/features/suites).
...
[`test/browser_tests/cucumber-new/step_definitions`](https://github.com/cfpb/cfgov-refresh/tree/master/test/browser_tests/cucumber-new/step_definitions).
